...
- `/prompt-autocomplete stats` reports current-session requests, failures, exact/prefix cache hits, suggestions shown and accepted, tokens, estimated cost, and mean provider latency
