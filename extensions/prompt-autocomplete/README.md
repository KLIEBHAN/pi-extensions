...
- `shown` counts visible ghost-text impressions. Streamed revisions of the same active suggestion do not inflate it; cycling to another alternative counts a new impression.
