...
- `/prompt-autocomplete stats` presents current-session requests, failures, exact and prefix cache hits, suggestions shown, full and word/chunk acceptance, token/cost totals, and mean provider latency without a live overlay or persistence.
